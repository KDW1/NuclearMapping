      ...
      <Link className='mx-auto w-min mt-4 min-w-max' href="/">
       ...
       </div>
       {
        ...
        <div className="mx-auto">
           ...
           <select id="metric" className="block outline-none mx-auto text-center mt-2 mb-2 px-2 rounded-lg w-min shadow-shade/75 shadow-xl transition duration-400 hover:scale-105 hover:-translate-y-1">
                {
