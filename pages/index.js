  ...
  return (
    ...
    <div className="px-12 py-4 bg-white mx-auto pt-4">
        ...
        <div className="text-center">
            ...
            <p className="text-sm sm:text-base w-5/6 sm:w-2/3 md:w-1/4 mx-auto text-red-300">We used the information listed under the {"Supplementary Information"} page</p>
        </div>
    </div>
