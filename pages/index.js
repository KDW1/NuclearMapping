  ...
  return (
    ...
    <div className="px-12 py-4 bg-white w-2/3 bruh:w-1/2 rounded-md my-2 mx-auto pt-4">
        ...
        <div className="text-center pb-4">
            ...
            <span className="text-lg text-gray-300 hover:text-red-500 duration-300 transition ease-in-out">programmed by</span><Link className="font-bold text-red-400 underline hover:text-red-500 transition-all duration-300" href="https://kingcode.dev">King-Diorr Willsun</Link>. <span className="text-lg text-gray-300 hover:text-red-500 duration-300 transition ease-in-out">Coordinated by</span> Dhruv Reddy, and Chris Serrao
            </p>
        </div>
    </div>
