...
async function tablesOfFirstFile() {
    ...
    await extracted.then(function(doc) { 
        ...
        tableTwo = createTable(docBody, 15, 17, 27, "Livestock Case", d);
        tableThree = createTable(docBody, 15, 29, 39, "Partial Livestock Case (50% livestock feed to human consumption, 50% livestock feed to livestock)", d);
        tableFour = createTable(docBody, 15, 40, 50, "No Livestock Case (50% livestock feed to human consumption)", d);
...
function createTable(document, metricLines, tableStart, tableEnd, title, description = '') {
